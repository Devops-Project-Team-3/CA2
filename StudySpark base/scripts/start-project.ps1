# StudySpark start script

Write-Host ""
Write-Host "========================================"
Write-Host " Starting StudySpark"
Write-Host "========================================"
Write-Host ""
...
Write-Host "[PASS] Docker is ready."
Write-Host "[INFO] Starting frontend and backend containers..."
Write-Host ""
...
if ($LASTEXITCODE -ne 0) {
    Write-Host ""
    Write-Host "[ERROR] StudySpark failed to start."
    exit 1
}

Write-Host ""
Write-Host "========================================"
Write-Host " StudySpark started successfully"
Write-Host "========================================"
Write-Host ""
